  ...
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"
      ...
      <el-table-column label="启用">
        <template slot-scope="scope">
<!--          active-value加: 整数-->
          <el-switch :active-value="1" :inactive-value="0" v-model="scope.row.enable" active-color="#13ce66" inactive-color="#ccc"
...
export default {
  ...
  methods: {
    ...
    del(id) {
      this.request.post("http://localhost:9090/file/" + id).then(res => {
        if (res) {
